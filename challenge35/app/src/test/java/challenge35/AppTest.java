...
class AppTest {
    ...
    public void testAddEdge() {
        ...
        assertTrue(graph.getNeighbors(vertexA).stream().anyMatch(edge -> edge.destination == vertexB));
    }
    ...
    public void testGetNeighborsWithWeight() {
        ...
        int weight = graph.getNeighbors(vertexA).stream()
                .filter(edge -> edge.destination == vertexB)
                .findFirst()
    ...
    public void testGraphWithOneVertexAndEdge() {
        ...
        assertTrue(graph.getNeighbors(vertexA).stream().anyMatch(edge -> edge.destination == vertexA && edge.weight == 0));
    }
}